...
// skill script --->
    ...
    function createStudentCards(){
        ...
        for(let i=0;i<studentDetails.length;i++){
            ...
            if(studentDetails[i].photoLink==="")
                sImage.setAttribute('src',"person.png");
            else
        ...
        if(images!==null){
            images.forEach(eachImage=>{
                ...
                console.log(eachImage.parentElement.children[0].children[0].offsetHeight);
            }); 
        }
    }
